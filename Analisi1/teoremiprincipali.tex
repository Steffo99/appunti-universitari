...
\begin{itemize}
    \item Se \(M = +\infty\), allora \(y_n = n\) (e la successione \(\to +\infty\)).
    \item Se \(M \neq +\infty\), allora \(y_n = M - \frac{1}{n}\) (e la successione \(\to M\)).
\end{itemize}
...
Possiamo provare a calcolare il rapporto incrementale (senza limite): \(\frac{f(x) - f(x_0)}{x - x_0}\).\\
...
Essendo la funzione \textbf{derivabile}, l'unica possibilità è che \(f(x_0) = 0\).
